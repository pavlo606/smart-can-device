...
{
    Sim7000::onDataReceived(huart, Size, App::s_sim7000);
}

void HAL_UART_ErrorCallback(UART_HandleTypeDef* huart)
{
    Sim7000::onErrorOccured(huart, App::s_sim7000);
}
}

//------------------------------------------

Sim7000* App::s_sim7000 = nullptr;

void App::startLteThread()
{
    printf("============ Start LTE Thread ==============\n");
    Sim7000 l_sim700;
    s_sim7000 = &l_sim700;

    s_sim7000->startThread();
}
